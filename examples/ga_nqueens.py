...
def fitness_fn(x): return 1. / evalNQueens(x)
...
def generational_with_elitism():
    np.random.seed(42)
    pop = pg.genetic_algorithm_permutation(fitness_fn, nqueens_size, elitism=True,
                                           total_generations=200, cx_rate=0.5, ind_mt_rate=0.2, op_mt_rate=3.0 / nqueens_size)
